# DO NOT EDIT THIS FILE BY HAND! Instead edit the R Markdown source file `Rmd/funky.Rmd` and run `pkgpurl::purl_rmd()`.
# See `README.md#r-markdown-format` for more information on the literate programming approach used applying the R Markdown format.

# funky: Canonicalized R package configuration
