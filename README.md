...
<a href="https://cran.r-project.org/package=funky" class="pkgdown-release"><img src="https://r-pkg.org/badges/version/funky" alt="CRAN Status" /></a>

A canonicalized way to R package configuration striving for user and developer convenience alike.

## Documentation

[![Netlify Status](https://api.netlify.com/api/v1/badges//deploy-status)](https://app.netlify.com/sites/-rpkg-dev/deploys)

The documentation of this package is found [here](https://funky.rpkg.dev).
...
-   R source code is *not* split over several files as [suggested by the TSG](https://style.tidyverse.org/package-files.html) but instead is (as far as possible) kept in the single file [`Rmd/funky.Rmd`](Rmd/funky.Rmd) which is well-structured thanks to its [Markdown support](#r-markdown-format).
